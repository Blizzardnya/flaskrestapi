...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://todoadmin:todoadmin@localhost/todo'
...
def get_all_users(current_user):
    ...
    for user in users:
        output.append({'public_id': user.public_id, 'name': user.name, 'password': user.password,
                       'admin': user.admin})
...
def get_one_user(current_user, public_id):
    ...
    return jsonify({'user': {'public_id': user.public_id, 'name': user.name,
...
def get_one_todo(current_user, todo_id):
    ...
    return jsonify({'todo': {'id': todo.id, 'text': todo.text, 'complete': todo.complete}})
